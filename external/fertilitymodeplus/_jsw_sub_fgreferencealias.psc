...
event	OnUpdateGameTime()
	if (GetReference() == none) || !GetOwningQuest().IsRunning()
		GoToState("Dead")
		Game.GetPlayer().RemoveFromFaction(FGFaction)
		return
	endIf
	GoToState("FillForms")
...
;	playerRef.SetFactionRank(FGFaction, (16 * running as int))
	; 2.54
	(GetReference() as actor).SetFactionRank(FGFaction, (16 * running as int))
...
state FillForms
	...
	event OnUpdate()
		...
		GoToState("")
		debug.trace("FM+: FGReferenceAlias retreived forms")
